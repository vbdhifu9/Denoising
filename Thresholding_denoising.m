...
data =cell2mat(struct2cell(load('E:\LiYuan -research project\微地震去噪\一种新的curvelet联合滤波噪声压制技术\Research\Denoising-main - copy\Denoising-main\Data\matlab_noisy_data.mat')))
dataorg=data;
